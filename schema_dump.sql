...
--
-- Name: firewall; Type: SCHEMA; Schema: -; Owner: -
--
...
CREATE EXTENSION IF NOT EXISTS amcheck WITH SCHEMA extensions;
...
--
-- Name: enforce_single_session(); Type: FUNCTION; Schema: auth; Owner: -
--

CREATE FUNCTION auth.enforce_single_session() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- Only enforce single session if the user does NOT allow multi-session
  IF NOT EXISTS (
    SELECT 1
    FROM auth.users u
    WHERE u.id = NEW.user_id
      AND u.allow_multi_session = true
  ) THEN
...
--
-- Name: hosts; Type: TABLE; Schema: firewall; Owner: -
--

CREATE TABLE firewall.hosts (
    id integer NOT NULL,
...
--
-- Name: get_hosts(); Type: FUNCTION; Schema: firewall; Owner: -
--

CREATE FUNCTION firewall.get_hosts() RETURNS SETOF firewall.hosts
    LANGUAGE sql STABLE
    SET search_path TO ''
    AS $$
  select * from firewall.hosts;
$$;


--
-- Name: ip_whitelist; Type: TABLE; Schema: firewall; Owner: -
--

CREATE TABLE firewall.ip_whitelist (
    id integer NOT NULL,
    ip inet NOT NULL,
    description text,
    added_by text,
...
--
-- Name: get_ip_whitelist(); Type: FUNCTION; Schema: firewall; Owner: -
--

CREATE FUNCTION firewall.get_ip_whitelist() RETURNS SETOF firewall.ip_whitelist
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO ''
    AS $$
  select * from firewall.ip_whitelist;
$$;


--
-- Name: notify_hosts_change(); Type: FUNCTION; Schema: firewall; Owner: -
--

CREATE FUNCTION firewall.notify_hosts_change() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO ''
    AS $$
BEGIN
  PERFORM pg_catalog.pg_notify('hosts_changed', '');
  RETURN NEW;
END;
$$;
...
--
-- Name: notify_ip_whitelist_change(); Type: FUNCTION; Schema: firewall; Owner: -
--

CREATE FUNCTION firewall.notify_ip_whitelist_change() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO ''
    AS $$
BEGIN
  PERFORM pg_catalog.pg_notify('ip_whitelist_changed', '');
  RETURN NEW;
END;
$$;
...
--
-- Name: prevent_redundant_ip(); Type: FUNCTION; Schema: firewall; Owner: -
--

CREATE FUNCTION firewall.prevent_redundant_ip() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO ''
    AS $$
BEGIN
  -- Check if NEW.ip is already contained in an existing range
  IF EXISTS (
    SELECT 1
    FROM firewall.resolved_ips r
    WHERE NEW.ip <<= r.ip
  ) THEN
    RAISE EXCEPTION 'IP range % is already covered by existing range(s)', NEW.ip;
  END IF;

  -- Also check if NEW.ip would cover an existing range (optional)
  IF EXISTS (
    SELECT 1
    FROM firewall.resolved_ips r
    WHERE r.ip <<= NEW.ip
  ) THEN
    RAISE EXCEPTION 'IP range % would cover an existing range(s)', NEW.ip;
  END IF;
...
--
-- Name: upsert_host(text, text, boolean); Type: FUNCTION; Schema: firewall; Owner: -
--

CREATE FUNCTION firewall.upsert_host(p_hostname text, p_description text DEFAULT NULL::text, p_active boolean DEFAULT true) RETURNS firewall.hosts
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO ''
    AS $$
declare
  v_host firewall.hosts;
begin
  insert into firewall.hosts (hostname, description, active)
  values (p_hostname, p_description, p_active)
...
--
-- Name: upsert_ip_whitelist(inet, text, boolean); Type: FUNCTION; Schema: firewall; Owner: -
--

CREATE FUNCTION firewall.upsert_ip_whitelist(p_ip inet, p_description text DEFAULT NULL::text, p_active boolean DEFAULT true) RETURNS firewall.ip_whitelist
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO ''
    AS $$
declare
  v_row firewall.ip_whitelist;
begin
  insert into firewall.ip_whitelist (ip, description, active, added_by)
  values (p_ip, p_description, p_active, auth.uid()::text)
...
BEGIN
    ...
    child_orders AS (
        SELECT 
            o.id,
            -- ✅ NEW: Dynamic Order Type Generation
            COALESCE(
                (
                    SELECT string_agg(eoj.name, ' & ')
                    FROM public.orders_jobs oj
            ...
            o.order_color
        FROM public.orders o
        WHERE o.tag = '#' || order_id_param::text
    ),
...
CREATE FUNCTION public.get_orders_with_tagged2(target_job_id bigint DEFAULT 16) RETURNS jsonb
  ...
  SELECT COALESCE(
    jsonb_agg(
      -- Merge Parent Columns + Calculated Fields
      (to_jsonb(p)
       || jsonb_build_object(
            'status', es.name,
            'company', ec.name,
...
begin
  ...
  select buckets.id into v_bucket_id from storage.buckets where buckets.name = bucketname;
    ...
    'with folders as (
       ...
       from storage.objects
         where objects.name ilike $2 || $3 || ''%''
           and bucket_id = $4
           and array_length(objects.path_tokens, 1) > $1  -- Corrected logic to find subfolders
       group by folder
     ...
     order by ' || v_order_by || ')
     limit $5
     offset $6' using levels, prefix, search, v_bucket_id, limits, offsets;
end;
$_$;
...
CREATE TABLE auth.users (
    ...
    allow_multi_session boolean DEFAULT false NOT NULL
);
...
--
-- Name: host_whitelist_id_seq; Type: SEQUENCE; Schema: firewall; Owner: -
--

CREATE SEQUENCE firewall.host_whitelist_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: host_whitelist_id_seq; Type: SEQUENCE OWNED BY; Schema: firewall; Owner: -
--

ALTER SEQUENCE firewall.host_whitelist_id_seq OWNED BY firewall.hosts.id;


--
-- Name: ip_whitelist_id_seq; Type: SEQUENCE; Schema: firewall; Owner: -
--

CREATE SEQUENCE firewall.ip_whitelist_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ip_whitelist_id_seq; Type: SEQUENCE OWNED BY; Schema: firewall; Owner: -
--

ALTER SEQUENCE firewall.ip_whitelist_id_seq OWNED BY firewall.ip_whitelist.id;


--
-- Name: resolved_ips; Type: TABLE; Schema: firewall; Owner: -
--

CREATE TABLE firewall.resolved_ips (
    id integer NOT NULL,
...
--
-- Name: resolved_ips_id_seq; Type: SEQUENCE; Schema: firewall; Owner: -
--

CREATE SEQUENCE firewall.resolved_ips_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: resolved_ips_id_seq; Type: SEQUENCE OWNED BY; Schema: firewall; Owner: -
--

ALTER SEQUENCE firewall.resolved_ips_id_seq OWNED BY firewall.resolved_ips.id;


--
-- Name: subdomains; Type: TABLE; Schema: firewall; Owner: -
--

CREATE TABLE firewall.subdomains (
    id integer NOT NULL,
...
--
-- Name: subdomains_id_seq; Type: SEQUENCE; Schema: firewall; Owner: -
--

CREATE SEQUENCE firewall.subdomains_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: subdomains_id_seq; Type: SEQUENCE OWNED BY; Schema: firewall; Owner: -
--

ALTER SEQUENCE firewall.subdomains_id_seq OWNED BY firewall.subdomains.id;
...
--
-- Name: messages_2026_01_05; Type: TABLE; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_06; Type: TABLE; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_07; Type: TABLE; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_08; Type: TABLE; Schema: realtime; Owner: -
--
...
--
-- Name: sql_snippets; Type: TABLE; Schema: studio; Owner: -
--

CREATE TABLE studio.sql_snippets (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: messages_2026_01_05; Type: TABLE ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_06; Type: TABLE ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_07; Type: TABLE ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_08; Type: TABLE ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: hosts id; Type: DEFAULT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.hosts ALTER COLUMN id SET DEFAULT nextval('firewall.host_whitelist_id_seq'::regclass);


--
-- Name: ip_whitelist id; Type: DEFAULT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.ip_whitelist ALTER COLUMN id SET DEFAULT nextval('firewall.ip_whitelist_id_seq'::regclass);


--
-- Name: resolved_ips id; Type: DEFAULT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.resolved_ips ALTER COLUMN id SET DEFAULT nextval('firewall.resolved_ips_id_seq'::regclass);


--
-- Name: subdomains id; Type: DEFAULT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.subdomains ALTER COLUMN id SET DEFAULT nextval('firewall.subdomains_id_seq'::regclass);
...
--
-- Name: hosts host_whitelist_hostname_key; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.hosts
    ADD CONSTRAINT host_whitelist_hostname_key UNIQUE (hostname);


--
-- Name: hosts host_whitelist_pkey; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.hosts
    ADD CONSTRAINT host_whitelist_pkey PRIMARY KEY (id);


--
-- Name: ip_whitelist ip_whitelist_ip_key; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.ip_whitelist
    ADD CONSTRAINT ip_whitelist_ip_key UNIQUE (ip);


--
-- Name: ip_whitelist ip_whitelist_pkey; Type: CONSTRAINT; Schema: firewall; Owner: -
--
...
--
-- Name: resolved_ips resolved_ips_ip_key; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.resolved_ips
    ADD CONSTRAINT resolved_ips_ip_key UNIQUE (ip);


--
-- Name: resolved_ips resolved_ips_pkey; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.resolved_ips
    ADD CONSTRAINT resolved_ips_pkey PRIMARY KEY (id);


--
-- Name: resolved_ips resolved_ips_unique; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.resolved_ips
    ADD CONSTRAINT resolved_ips_unique UNIQUE (subdomain_id, ip);


--
-- Name: subdomains subdomains_pkey; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.subdomains
    ADD CONSTRAINT subdomains_pkey PRIMARY KEY (id);


--
-- Name: subdomains subdomains_subdomain_key; Type: CONSTRAINT; Schema: firewall; Owner: -
--
...
--
-- Name: subdomains subdomains_unique; Type: CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.subdomains
    ADD CONSTRAINT subdomains_unique UNIQUE (host_id, subdomain);
...
--
-- Name: messages_2026_01_05 messages_2026_01_05_pkey; Type: CONSTRAINT; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_06 messages_2026_01_06_pkey; Type: CONSTRAINT; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_07 messages_2026_01_07_pkey; Type: CONSTRAINT; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_08 messages_2026_01_08_pkey; Type: CONSTRAINT; Schema: realtime; Owner: -
--
...
--
-- Name: sql_snippets sql_snippets_pkey; Type: CONSTRAINT; Schema: studio; Owner: -
--

ALTER TABLE ONLY studio.sql_snippets
...
--
-- Name: resolved_ips_ip_gist_idx; Type: INDEX; Schema: firewall; Owner: -
--

CREATE INDEX resolved_ips_ip_gist_idx ON firewall.resolved_ips USING gist (ip inet_ops);
...
--
-- Name: idx_phones_order_active_job; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_phones_order_active_job ON public.phones USING btree (order_id, current_job) WHERE (is_active = true);
...
--
-- Name: messages_2026_01_05_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_06_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_07_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_08_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_05_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_05_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_06_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_06_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_07_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_07_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_08_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2026_01_08_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: sessions single_session_trigger; Type: TRIGGER; Schema: auth; Owner: -
--

CREATE TRIGGER single_session_trigger AFTER INSERT ON auth.sessions FOR EACH ROW EXECUTE FUNCTION auth.enforce_single_session();


--
-- Name: hosts hosts_change; Type: TRIGGER; Schema: firewall; Owner: -
--

CREATE TRIGGER hosts_change AFTER INSERT OR DELETE OR UPDATE ON firewall.hosts FOR EACH STATEMENT EXECUTE FUNCTION firewall.notify_hosts_change();


--
-- Name: ip_whitelist ip_whitelist_change; Type: TRIGGER; Schema: firewall; Owner: -
--

CREATE TRIGGER ip_whitelist_change AFTER INSERT OR DELETE OR UPDATE ON firewall.ip_whitelist FOR EACH STATEMENT EXECUTE FUNCTION firewall.notify_ip_whitelist_change();


--
-- Name: resolved_ips resolved_ips_prevent_redundant; Type: TRIGGER; Schema: firewall; Owner: -
--

CREATE TRIGGER resolved_ips_prevent_redundant BEFORE INSERT OR UPDATE ON firewall.resolved_ips FOR EACH ROW EXECUTE FUNCTION firewall.prevent_redundant_ip();
...
--
-- Name: hosts host_whitelist_added_by_fkey; Type: FK CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.hosts
    ADD CONSTRAINT host_whitelist_added_by_fkey FOREIGN KEY (added_by) REFERENCES public.technicians(uuid);


--
-- Name: resolved_ips resolved_ips_subdomain_id_fkey; Type: FK CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.resolved_ips
    ADD CONSTRAINT resolved_ips_subdomain_id_fkey FOREIGN KEY (subdomain_id) REFERENCES firewall.subdomains(id) ON DELETE CASCADE;


--
-- Name: subdomains subdomains_host_id_fkey; Type: FK CONSTRAINT; Schema: firewall; Owner: -
--

ALTER TABLE ONLY firewall.subdomains
    ADD CONSTRAINT subdomains_host_id_fkey FOREIGN KEY (host_id) REFERENCES firewall.hosts(id) ON DELETE CASCADE;
...
--
-- Name: objects authenticated users with has_order_access all; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "authenticated users with has_order_access all" ON storage.objects TO authenticated USING (public.has_order_access('all'::text));
...
--
-- Name: sql_snippets basic usage; Type: POLICY; Schema: studio; Owner: -
--

CREATE POLICY "basic usage" ON studio.sql_snippets TO authenticated USING (true);


--
-- Name: sql_snippets; Type: ROW SECURITY; Schema: studio; Owner: -
--

ALTER TABLE studio.sql_snippets ENABLE ROW LEVEL SECURITY;
...
--
-- Name: supabase_realtime TAC_database; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public."TAC_database";


--
-- Name: supabase_realtime channel_members; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime channels; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime daily_report_new; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.daily_report_new;


--
-- Name: supabase_realtime enum_companies; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_companies;


--
-- Name: supabase_realtime enum_damages; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_damages;


--
-- Name: supabase_realtime enum_grade; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_grade;


--
-- Name: supabase_realtime enum_jobs; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_jobs;


--
-- Name: supabase_realtime enum_models; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_models;


--
-- Name: supabase_realtime enum_order_jobs; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_order_jobs;


--
-- Name: supabase_realtime enum_phone_done; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_phone_done;


--
-- Name: supabase_realtime enum_roles; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_roles;


--
-- Name: supabase_realtime enum_status; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.enum_status;
...
--
-- Name: supabase_realtime jobs_assigned; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.jobs_assigned;


--
-- Name: supabase_realtime managers; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.managers;
...
--
-- Name: supabase_realtime notification_reads; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime orders_archive; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.orders_archive;


--
-- Name: supabase_realtime orders_jobs; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.orders_jobs;


--
-- Name: supabase_realtime outside_repair_phones; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.outside_repair_phones;


--
-- Name: supabase_realtime outside_repairs; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.outside_repairs;


--
-- Name: supabase_realtime parts_inventory; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.parts_inventory;


--
-- Name: supabase_realtime parts_inventory_models; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.parts_inventory_models;


--
-- Name: supabase_realtime parts_queue; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.parts_queue;


--
-- Name: supabase_realtime phone_grades; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.phone_grades;


--
-- Name: supabase_realtime phone_jobs_done; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.phone_jobs_done;


--
-- Name: supabase_realtime phone_update_log; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.phone_update_log;


--
-- Name: supabase_realtime phones; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.phones;


--
-- Name: supabase_realtime repair_jobs; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.repair_jobs;


--
-- Name: supabase_realtime repairs; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.repairs;


--
-- Name: supabase_realtime reports; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime supplies_inventory; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.supplies_inventory;


--
-- Name: supabase_realtime supplies_order_history; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.supplies_order_history;


--
-- Name: supabase_realtime technicians; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.technicians;


--
-- Name: supabase_realtime timesheet; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.timesheet;
